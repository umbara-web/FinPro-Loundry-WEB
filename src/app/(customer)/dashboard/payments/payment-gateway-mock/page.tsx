      ...
      <div className='w-full max-w-md overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-xl'>
        ...
        <div className='flex flex-col gap-6 p-8'>
          <div className='text-center'>
            <p className='mb-1 text-sm text-slate-500'>Total Payment</p>
          ...
          <div className='space-y-4 border-t border-b border-slate-100 py-6'>
            ...
            <div className='flex justify-between'>
              ...
              <span className='font-bold text-blue-600'>{method}</span>
            </div>
          </div>
          ...
          <div className='space-y-3'>
            <button
              ...
              disabled={processing}
              className='flex w-full items-center justify-center gap-2 rounded-xl bg-green-500 px-4 py-3 font-bold text-white shadow-lg shadow-green-500/20 transition-colors hover:bg-green-600 disabled:cursor-not-allowed disabled:opacity-50'
            >
            ...
            <button
              ...
              disabled={processing}
              className='w-full rounded-xl bg-red-50 px-4 py-3 font-bold text-red-600 transition-colors hover:bg-red-100 disabled:opacity-50'
            >
