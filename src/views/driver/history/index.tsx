            ...
            <div className='flex flex-wrap items-center gap-4'>
              <div className='flex flex-col gap-1.5'>
                ...
                <select
                  ...
                  className='min-w-40 rounded-lg border border-[#304d69] bg-[#101922] px-4 py-2 text-sm text-white focus:border-[#0a7ff5] focus:ring-[#0a7ff5]'
                >
            ...
            filteredJobs.map((job) => (
              ...
              >
                ...
                <div className='flex flex-col items-end'>
                  ...
                  <p className='text-sm font-semibold whitespace-nowrap text-slate-200'>
