    ...
    <div className='flex h-full flex-col overflow-hidden bg-[#f6f7f8] dark:bg-[#101922]'>
      ...
      <main className='flex-1 overflow-y-auto p-4 md:p-6 lg:p-8'>
        <div className='mx-auto w-full max-w-lg space-y-6'>
          {/* Profile Card */}
          <div className='dark:bg-surface-dark rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-slate-800'>
            <div className='flex flex-col items-center'>
              <div className='mb-4 h-24 w-24 overflow-hidden rounded-full border-4 border-slate-100 bg-slate-200 dark:border-slate-700 dark:bg-slate-700'>
