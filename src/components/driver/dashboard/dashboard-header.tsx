...
interface DashboardHeaderProps {
  user: any; // We'll fix the strict type if needed, utilizing useAuth usually provides it
  isOnline: boolean;
  onStatusChange: (status: boolean) => void;
}

export function DashboardHeader({ user, isOnline, onStatusChange }: DashboardHeaderProps) {
  return (
